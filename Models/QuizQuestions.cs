...
namespace BlazorQuiz.Models
{
    ...
    public partial class QuizQuestions
    {
        public static QuizQuestions FromJson(string json) => JsonConvert.DeserializeObject<QuizQuestions>(json, BlazorQuiz.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this QuizQuestions self) => JsonConvert.SerializeObject(self, BlazorQuiz.Models.Converter.Settings);
    }
